...
public static class HttpMethodsExtention
{
    ...
    {
        var response = await client.GetAsJsonAsync(route, query);
    ...
    {
        var response = await client.PostAsJsonAsync(route, query);
    ...
    {
        var response = await client.PutAsJsonAsync(route, query);
    ...
    {
        var response = await client.DeleteAsJsonAsync(route, id);
    ...
    {
        Exception exception;
        var errorMessage = await ReadFromJson<ErrorModel>(responseMessage);
