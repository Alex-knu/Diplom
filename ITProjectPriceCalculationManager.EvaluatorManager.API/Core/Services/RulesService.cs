...
internal class RulesService : BaseService<Rules, Guid, RulesDTO, ITProjectPriceCalculationEvaluatorManagerDbContext>, IRulesService
{
    public RulesService(IRepository<Rules, Guid, ITProjectPriceCalculationEvaluatorManagerDbContext> repository, IMapper mapper) : base(repository, mapper)
    {
    }
