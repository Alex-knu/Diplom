...
internal static class SeedData
{
    ...
    private static void SeedAttribute(ModelBuilder builder)
    {
        builder.Entity<Attribute>().HasData(
            ...
            new Attribute
                { Id = new Guid("EA5A8D97-0940-4463-B07A-D6A10B6F0D08"), Name = "Schedule restrictions(SCED)" },
            new Attribute
            {
            ...
            new Attribute
                { Id = new Guid("4FEAB03A-7415-4C72-8B3F-6901E014C25E"), Name = "Complexity and reliability(RCPX)" },
            ...
            new Attribute
                { Id = new Guid("B4A2B0B2-35C4-41D4-8CA7-1D2EBD1440E9"), Name = "Development flexibility(FLEX)" },
            new Attribute
            {
            ...
            new Attribute
            {
                Id = new Guid("74B32655-E330-4E74-A1A2-E1E92023F676"), Name = "Cohesion of the development team(TEAM)"
            },
            new Attribute
            {
    ...
    private static void SeedProgramLanguage(ModelBuilder builder)
    {
        builder.Entity<ProgramLanguage>().HasData(
            new ProgramLanguage
                { Id = new Guid("794b2ac4-3310-4264-a367-d1e665a55458"), Name = "ABAP (SAP)", SLOC = 28 },
            new ProgramLanguage { Id = new Guid("c26246c3-caad-4d34-a42a-f6517cf45ef6"), Name = "ASP", SLOC = 51 },
            new ProgramLanguage
                { Id = new Guid("e3810495-b6ab-42af-87a6-9ba5f7393cd5"), Name = "Assembler", SLOC = 119 },
            ...
            new ProgramLanguage
            {
                Id = new Guid("32c19d74-6993-4d0e-8647-cdf75541e728"), Name = "Cognos Impromptu Scripts +", SLOC = 47
            },
            new ProgramLanguage
            {
                Id = new Guid("00240fb2-4f29-431f-93b9-adfa31ceaaca"), Name = "Cross System Products (CSP) +", SLOC = 20
            },
            new ProgramLanguage
                { Id = new Guid("b8c17601-7672-4b36-b4d5-975573edcaba"), Name = "Cool:Gen/IEF", SLOC = 32 },
            new ProgramLanguage
                { Id = new Guid("676bd39b-61fa-4718-af90-e2378851acdd"), Name = "Datastage", SLOC = 71 },
            ...
            new ProgramLanguage
                { Id = new Guid("ee1f313e-9603-4ebe-a3bd-e0da9c639a7d"), Name = "JavaScript", SLOC = 47 },
            ...
            new ProgramLanguage
                { Id = new Guid("9f9752c2-18db-4b97-9d61-752b20aabb0c"), Name = "Lotus Notes", SLOC = 23 },
    ...
    private static void SeedDifficultyLevelsTypeToFactorType(ModelBuilder builder)
    {
        builder.Entity<DifficultyLevelsTypeToFactorType>().HasData(
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 2.12
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorId = new Guid("7A0822A4-7012-4738-889B-FAFB713F72EA"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1.62
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorId = new Guid("7A0822A4-7012-4738-889B-FAFB713F72EA"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1.26
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorId = new Guid("7A0822A4-7012-4738-889B-FAFB713F72EA"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorId = new Guid("7A0822A4-7012-4738-889B-FAFB713F72EA"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 0.83
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorId = new Guid("7A0822A4-7012-4738-889B-FAFB713F72EA"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 0.63
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorId = new Guid("7A0822A4-7012-4738-889B-FAFB713F72EA"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 0.5
            },
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1.59
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("0C5FD362-B14D-4186-BEF9-979ED21B9575"),
                FactorId = new Guid("24FBF4F3-AA84-4B17-9D2E-0EF16238A2BA"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1.33
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("FC6EA190-24A2-42D0-B2AA-783758EFA82D"),
                FactorId = new Guid("24FBF4F3-AA84-4B17-9D2E-0EF16238A2BA"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1.12
            },
            new DifficultyLevelsTypeToFactorType
            {
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("1AA2EF63-41DB-4F3D-AACD-E38C7E4639AC"),
                FactorId = new Guid("24FBF4F3-AA84-4B17-9D2E-0EF16238A2BA"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 0.87
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("F5AD4A31-A240-41BD-BFFD-245103B88D0F"),
                FactorId = new Guid("24FBF4F3-AA84-4B17-9D2E-0EF16238A2BA"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 0.71
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("C15C008F-F7F4-4DAE-95BB-02A32BB2B8B1"),
                FactorId = new Guid("24FBF4F3-AA84-4B17-9D2E-0EF16238A2BA"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 0.62
            },
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1.43
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("0C5FD362-B14D-4186-BEF9-979ED21B9575"),
                FactorId = new Guid("33E07DED-1BD4-4E9A-8076-F071EA1A5269"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1.3
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("FC6EA190-24A2-42D0-B2AA-783758EFA82D"),
                FactorId = new Guid("33E07DED-1BD4-4E9A-8076-F071EA1A5269"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1.1
            },
            new DifficultyLevelsTypeToFactorType
            {
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("F5AD4A31-A240-41BD-BFFD-245103B88D0F"),
                FactorId = new Guid("33E07DED-1BD4-4E9A-8076-F071EA1A5269"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 0.73
            },
            new DifficultyLevelsTypeToFactorType
            {
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 0
            },
            new DifficultyLevelsTypeToFactorType
            {
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("FC6EA190-24A2-42D0-B2AA-783758EFA82D"),
                FactorId = new Guid("EA5A8D97-0940-4463-B07A-D6A10B6F0D08"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1.14
            },
            new DifficultyLevelsTypeToFactorType
            {
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("1AA2EF63-41DB-4F3D-AACD-E38C7E4639AC"),
                FactorId = new Guid("FE85D6AB-ADE6-412F-B2A6-7CA97F4F1DA4"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1.29
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("F5AD4A31-A240-41BD-BFFD-245103B88D0F"),
                FactorId = new Guid("FE85D6AB-ADE6-412F-B2A6-7CA97F4F1DA4"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1.81
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("C15C008F-F7F4-4DAE-95BB-02A32BB2B8B1"),
                FactorId = new Guid("FE85D6AB-ADE6-412F-B2A6-7CA97F4F1DA4"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 2.61
            },
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 0.49
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("0C5FD362-B14D-4186-BEF9-979ED21B9575"),
                FactorId = new Guid("4FEAB03A-7415-4C72-8B3F-6901E014C25E"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 0.6
            },
            new DifficultyLevelsTypeToFactorType
            {
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("F5AD4A31-A240-41BD-BFFD-245103B88D0F"),
                FactorId = new Guid("4FEAB03A-7415-4C72-8B3F-6901E014C25E"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1.97
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("C15C008F-F7F4-4DAE-95BB-02A32BB2B8B1"),
                FactorId = new Guid("4FEAB03A-7415-4C72-8B3F-6901E014C25E"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 2.72
            },
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("FC6EA190-24A2-42D0-B2AA-783758EFA82D"),
                FactorId = new Guid("9B7D2F14-9EC0-414C-806B-D5E607664031"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 0.95
            },
            new DifficultyLevelsTypeToFactorType
            {
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("1AA2EF63-41DB-4F3D-AACD-E38C7E4639AC"),
                FactorId = new Guid("9B7D2F14-9EC0-414C-806B-D5E607664031"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1.07
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("F5AD4A31-A240-41BD-BFFD-245103B88D0F"),
                FactorId = new Guid("9B7D2F14-9EC0-414C-806B-D5E607664031"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1.15
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("C15C008F-F7F4-4DAE-95BB-02A32BB2B8B1"),
                FactorId = new Guid("9B7D2F14-9EC0-414C-806B-D5E607664031"),
                FactorTypeId = new Guid("B03771E5-488A-449F-B886-19C581B63CDE"), Value = 1.24
            },
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 6.2
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("FC6EA190-24A2-42D0-B2AA-783758EFA82D"),
                FactorId = new Guid("15140CFD-EACC-41F3-AAE5-718980DA88B9"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 4.96
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("B29FA523-BD56-48BE-9ADC-CBD23F0AF646"),
                FactorId = new Guid("15140CFD-EACC-41F3-AAE5-718980DA88B9"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 3.72
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("1AA2EF63-41DB-4F3D-AACD-E38C7E4639AC"),
                FactorId = new Guid("15140CFD-EACC-41F3-AAE5-718980DA88B9"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 2.48
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("F5AD4A31-A240-41BD-BFFD-245103B88D0F"),
                FactorId = new Guid("15140CFD-EACC-41F3-AAE5-718980DA88B9"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 1.24
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("C15C008F-F7F4-4DAE-95BB-02A32BB2B8B1"),
                FactorId = new Guid("15140CFD-EACC-41F3-AAE5-718980DA88B9"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 0
            },
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 5.07
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("FC6EA190-24A2-42D0-B2AA-783758EFA82D"),
                FactorId = new Guid("B4A2B0B2-35C4-41D4-8CA7-1D2EBD1440E9"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 4.05
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("B29FA523-BD56-48BE-9ADC-CBD23F0AF646"),
                FactorId = new Guid("B4A2B0B2-35C4-41D4-8CA7-1D2EBD1440E9"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 3.04
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("1AA2EF63-41DB-4F3D-AACD-E38C7E4639AC"),
                FactorId = new Guid("B4A2B0B2-35C4-41D4-8CA7-1D2EBD1440E9"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 2.03
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("F5AD4A31-A240-41BD-BFFD-245103B88D0F"),
                FactorId = new Guid("B4A2B0B2-35C4-41D4-8CA7-1D2EBD1440E9"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 1.01
            },
            new DifficultyLevelsTypeToFactorType
            {
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 7.07
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("FC6EA190-24A2-42D0-B2AA-783758EFA82D"),
                FactorId = new Guid("186476D2-772B-4EB1-B140-B0C1A238AE11"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 5.65
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("B29FA523-BD56-48BE-9ADC-CBD23F0AF646"),
                FactorId = new Guid("186476D2-772B-4EB1-B140-B0C1A238AE11"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 4.24
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("1AA2EF63-41DB-4F3D-AACD-E38C7E4639AC"),
                FactorId = new Guid("186476D2-772B-4EB1-B140-B0C1A238AE11"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 2.83
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("F5AD4A31-A240-41BD-BFFD-245103B88D0F"),
                FactorId = new Guid("186476D2-772B-4EB1-B140-B0C1A238AE11"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 1.41
            },
            new DifficultyLevelsTypeToFactorType
            {
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 5.48
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("FC6EA190-24A2-42D0-B2AA-783758EFA82D"),
                FactorId = new Guid("74B32655-E330-4E74-A1A2-E1E92023F676"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 4.38
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("B29FA523-BD56-48BE-9ADC-CBD23F0AF646"),
                FactorId = new Guid("74B32655-E330-4E74-A1A2-E1E92023F676"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 3.29
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("1AA2EF63-41DB-4F3D-AACD-E38C7E4639AC"),
                FactorId = new Guid("74B32655-E330-4E74-A1A2-E1E92023F676"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 2.19
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("F5AD4A31-A240-41BD-BFFD-245103B88D0F"),
                FactorId = new Guid("74B32655-E330-4E74-A1A2-E1E92023F676"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 1.1
            },
            new DifficultyLevelsTypeToFactorType
            {
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 7.8
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("FC6EA190-24A2-42D0-B2AA-783758EFA82D"),
                FactorId = new Guid("C69EDB03-4FB6-4071-BCC5-F158808C69EE"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 6.24
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("B29FA523-BD56-48BE-9ADC-CBD23F0AF646"),
                FactorId = new Guid("C69EDB03-4FB6-4071-BCC5-F158808C69EE"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 4.68
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("1AA2EF63-41DB-4F3D-AACD-E38C7E4639AC"),
                FactorId = new Guid("C69EDB03-4FB6-4071-BCC5-F158808C69EE"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 3.12
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("F5AD4A31-A240-41BD-BFFD-245103B88D0F"),
                FactorId = new Guid("C69EDB03-4FB6-4071-BCC5-F158808C69EE"),
                FactorTypeId = new Guid("EB8F98D6-1C46-4721-9AD6-C464B9029905"), Value = 1.56
            },
            new DifficultyLevelsTypeToFactorType
            {
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorTypeId = new Guid("CDD64D87-BB9A-4C17-B809-05C4454E6998"), Value = 7
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorId = new Guid("E777B5BF-559D-4194-A711-89CA4CA4A212"),
                FactorTypeId = new Guid("CDD64D87-BB9A-4C17-B809-05C4454E6998"), Value = 10
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("1AA2EF63-41DB-4F3D-AACD-E38C7E4639AC"),
                FactorId = new Guid("E777B5BF-559D-4194-A711-89CA4CA4A212"),
                FactorTypeId = new Guid("CDD64D87-BB9A-4C17-B809-05C4454E6998"), Value = 15
            },
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorTypeId = new Guid("CDD64D87-BB9A-4C17-B809-05C4454E6998"), Value = 5
            },
            new DifficultyLevelsTypeToFactorType
            {
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                FactorTypeId = new Guid("63715754-CDFB-4320-9C17-72648673CB4B"), Value = 3
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("5540D80E-8FAE-4AFB-A475-B49C1A9C4C2E"),
                FactorId = new Guid("73A3A716-F447-4057-99CA-1500D438BA58"),
                FactorTypeId = new Guid("63715754-CDFB-4320-9C17-72648673CB4B"), Value = 4
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("1AA2EF63-41DB-4F3D-AACD-E38C7E4639AC"),
                FactorId = new Guid("73A3A716-F447-4057-99CA-1500D438BA58"),
                FactorTypeId = new Guid("63715754-CDFB-4320-9C17-72648673CB4B"), Value = 6
            },
            ...
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("5540D80E-8FAE-4AFB-A475-B49C1A9C4C2E"),
                FactorId = new Guid("31F2F6D6-A5FA-4DA3-ADCF-0A5CC237EB95"),
                FactorTypeId = new Guid("63715754-CDFB-4320-9C17-72648673CB4B"), Value = 5
            },
            new DifficultyLevelsTypeToFactorType
            {
                ...
                DifficultyLevelId = new Guid("1AA2EF63-41DB-4F3D-AACD-E38C7E4639AC"),
                FactorId = new Guid("31F2F6D6-A5FA-4DA3-ADCF-0A5CC237EB95"),
                FactorTypeId = new Guid("63715754-CDFB-4320-9C17-72648673CB4B"), Value = 7
            },
