...
public class CalculatorManagerController : ControllerBase
{
    ...
    public CalculatorManagerController(ILogger<CalculatorManagerController> logger,
        ICalculatorService calculatorService, IHttpClientFactory httpClientFactory, IRouteService routeService)
    {
        _logger = logger;
